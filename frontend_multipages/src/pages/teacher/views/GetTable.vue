<template>
  <el-card class="references-container">
    <template #header>
      <div class="header">
        <el-button type="primary" :icon="Plus" @click="handleAdd">增加学生信息</el-button>
        <el-popconfirm
            title="确定删除吗？"
    ...
    />
    <DialogAddUser ref='addStu' :reload="table_data_reload"></DialogAddUser>
  </el-card>
</template>
...
import DialogAddUser from "@/components/DialogAddStudent.vue";
