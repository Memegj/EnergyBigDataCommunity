      ...
      <el-aside class="aside">
        ...
        >
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item-group>
              <el-menu-item index="/teacher/dataset">数据集检索</el-menu-item>
              <el-menu-item index="/teacher/dataset_manage">数据集管理</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="3">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/teacher/literature">文献资料检索</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="/teacher/literature_manage">文献资料管理</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="4">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/teacher/video">教学视频检索</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="/teacher/video_manage">教学视频管理</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="5">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/teacher/account">个人信息修改</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
