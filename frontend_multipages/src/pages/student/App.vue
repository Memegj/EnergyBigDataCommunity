      ...
      <el-aside class="aside">
        ...
        >
          ...
          <el-sub-menu index="4">
            ...
            <el-menu-item-group>
              <el-menu-item index="/student/video">教学视频检索</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group>
              <el-menu-item index="/student/video_manage">教学视频管理</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="5">
            <template #title>
...
import Header from '@/pages/student/components/Header.vue'
